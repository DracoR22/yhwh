use crate::{bind_group_manager::{BindGroupManager, TL}, common::constants::{HDR_TEX_FORMAT}, pipeline_builder::PipelineBuilder, renderer_common::{QUAD_VERTEX_BUFFER_LAYOUT, QUAD_VERTICES}, texture::{self, Texture}, uniform_manager::UniformManager, vertex::Vertex, wgpu_context::WgpuContext};
