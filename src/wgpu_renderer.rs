...
impl WgpuRenderer {
    ...
    pub fn new(window: &Arc<Window>, context: WgpuContext, game_data: &GameData) -> Self {
        ...
        let candle_flames_pass = FlamePass::new(&context);
    ...
    pub fn hot_load_shaders(&mut self) {
         ...
         self.render_passes.candle_flames_pass.hotload_shader(&self.wgpu_context);
